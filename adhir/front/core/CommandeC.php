...
function ajoutercommande($commande)
	{
		$sql="insert into commande (id_client,dateAchat,montantC,etatCommande) values (:id_client,:dateAchat,:montantC,:etatCommande)";
		...
		$req->bindValue(':etatCommande','en_cours');
