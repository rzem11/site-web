                  ...
                  <ul class="navbar-nav ">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           ...
                           <a class="nav-link " href="typography.html">chaises</a>
                        </div>
                     </li>
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           <a class="nav-link" href="product.html">salons</a>
                           <a class="nav-link " href="product.html">chambres a coucher</a>
                           <a class="nav-link " href="product.html">salle a manger</a>
                           <a class="nav-link " href="product.html">dressing</a>
