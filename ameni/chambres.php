   ...
   <body>
               ...
               <ul class="navbar-nav ">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="nav-link" href="icon.html">tables</a>
                        <a class="nav-link " href="typography.html">chairs</a>
                     </div>
                  </li>
      ...
      <section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Nos chambres à coucher</h3>
            <div class="row">
               ...
               <div class="left-ads-display col-lg-9">
                  <div class="row">
                      <?php
   include "config.php";
  $req="select * from prod where categ='chambres a coucher'";
...
$listP=$db->query($req) ;
      ...
      {   $id=$donnees['id'];      
        ...
        echo('<img style="height:300px; width:300px" src="produits/'.$donnees['photo'].'" class="img-fluid">');
             echo('</div>') ;
                  echo('<h4>');
