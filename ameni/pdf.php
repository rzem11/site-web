...
<head>
  ...
  <title>ERAYEN- Liste de produits</title>
  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        ...
        From
        <address>
          <strong>ERAYEN</strong><br>
          Les meubles à petit prix<br>
          Phone: (+216)73486500<br>
          Email: ERAYEN@gmail.tn
    ...
    <!-- Table row -->
                <table align="center"  class="table table-bordered" id="dataTable" width="100%" border="width:2px;" cellspacing="0">
            <thead>
                  <tr >
