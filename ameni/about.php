...
<html lang="zxx">
   <head>
      <title>About this product | Home :: w3layouts</title>
      <!--meta tags -->
      <meta charset="UTF-8">
...
<body>
               ...
               <ul>
                  <li>
                     ...
                     <li>
                        ...
                        <p><a href="mailto:info@example.com">Erayen@gmail.com</a></p>
                     </li>
                  <li>
                  </li>
               </ul>
         ...
         <div class="container-fluid">
            <div class="hedder-up row">
               <div class="col-lg-3 col-md-3 logo-head">
                  <h1><a class="navbar-brand" href="index.html">About</a></h1>
               </div>
               ...
               <ul class="navbar-nav ">
                  ...
                  <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           ...
                           <a class="nav-link" href="chambres.php">chambres a coucher</a>
                           <a class="nav-link" href="salle.php">salle a manger</a>
                           <a class="nav-link" href="dressing.php">dressing</a>
      ...
      <section class="about py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">About This Product</h3>
...
$listP=$db->query($req) ;
        ...
        { 
         ...
         echo('<h4>'.$donnees['nomP'].'</h4>');
         echo ('<table>');
         echo ('<tr>');
         echo ('<td>');
         echo('<img class="img-responsive" width="700" height="400" src="produits/'.$donnees['photo'].'">');
         echo ('</td>');
         ...
         echo ('<td>');
         echo('<div style="width: 500px " class="col-lg-6 col-md-6 address-w3l-right text-center">');
           
           echo "Réference du produit: ".$donnees['ref']." </br>";
           echo "Catégorie: ".$donnees['categ']." </br>";
           echo "Nom du Produit: ".$donnees['nomP']." </br>";
           echo "Prix Vente en gros: ".$donnees['prixVG']." Dt</br>";
           echo "Prix Vente en ligne: ".$donnees['prixVL']." Dt</br>";
           echo "Caractéristiques: ".$donnees['carac']." </br>"; 
           echo ('</td>');
           echo ('</tr>');  
           echo('</div>');
           echo('<td>');
...
<form method="get">
   <a  class="btn btn-primary btn-block" style="background-color:#C71346; width: 200px" href="pdf.php?id=<?php echo $id ?>">
Imprimer cette page
