...
if (isset($_GET['id']))
{
  $req="select * from catg where id=".$_GET['id'];
...
<td><input type="text" class="form-control" name="refC" placeholder="Saisir la réference"  onblur="verifRef(this)" value="<?php echo $refC ?>" style="width:500px">  </td>  

</tr>
   <tr>
    <td>
<label> Nom de la catégorie </label> </td>
<td><input type="text" class="form-control" name="nomC" placeholder="Saisir le nom" value="<?php echo $nomC ?>" onblur="verifRef(this)" style="width:500px"> </br>
</td>
</tr>
 <tr>
    <td>
<label> Nombre de produits </label></td> 
<td><input type="number" class="form-control" name="qteP" placeholder="Nombre de produits " value="<?php echo $qteP?>" onblur="verifqteP(this)"  style="width:500px"> </td>
</tr>
 <tr>
    <td>
<label> Date de création </label></td>
<td><input type="text" class="form-control" value="<?php echo date(DATE_RFC2822); ?>" name="datecreation"> </br>
</td>
</tr>
 <tr>
    <td>
...
<input type="text" class="form-control" name="description" placeholder="Saisir la description" value="<?php echo $description ?>"  style="width:500px"> </br>
</td>
</tr>
